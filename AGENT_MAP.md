...
| Route | Owns |
| --- | --- |
| `project-assembly` | Factory, source Engine candidates and Channels, generated-project Setup and `/maintenance`, All2CF MCP/project-token connection, paid updates, Blueprint, lifecycle updates, materializer, identity sync, `/dp` generation |
