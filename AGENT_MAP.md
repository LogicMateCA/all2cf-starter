...
| Route | Owns |
| --- | --- |
| `project-assembly` | Factory, source Engine candidates and Channels, generated-project Setup, Blueprint, lifecycle updates, materializer, identity sync, `/dp` generation |
...
| `design-stylekit` | StyleKit, design tokens, typography, modes and visual acceptance |
