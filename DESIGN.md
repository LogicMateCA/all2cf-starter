...
- `integrations/visual.json` pins draft `starter-integration@1.0.1` from Visual commit `9b1482690683cea17773ecd597c809731dcd882b`. `blueprint.visualIntegration` records the optional external plugin, target environment, receipt path and current resolution state; `.ai/plugins.json` keeps the functional and visual plugins independently installable.
