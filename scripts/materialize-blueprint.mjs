...
function renderDesignCSS(profile) {
...
function renderMobileDesign(profile) {
  return [
    "// Generated by scripts/materialize-blueprint.mjs. Do not edit by hand.",
...
const touchedPaths = new Set([blueprintPath, routeRegistryPath, ...generatedRegistries.map(({ path: file }) => file), statePath, packageLockPath]);
