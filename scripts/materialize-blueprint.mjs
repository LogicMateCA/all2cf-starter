...
const desiredState = { schemaVersion: "starter-materialization/v1", packs: {}, dependencies: Object.fromEntries(desiredDependencies), generatedRoutesHash: sha256(desiredRouteSource) };
...
const touchedPaths = new Set([blueprintPath, routeRegistryPath, statePath, packageLockPath]);
