...
type Snapshot = {
  ...
  assembly: {
    blueprint: {
      ...
      providers: { auth: string; socialAuth: string[]; database: DatabasePolicy; storage: StoragePolicy; email: { default: string; alternatives: string[] }; billing: string; release: string };
    };
...
const fallback: Snapshot = {
  ...
  assembly: {
    blueprint: {
      ...
      providers: { auth: "better-auth", socialAuth: ["google"], database: { engine: "postgresql", provider: "native-postgresql", access: "sql-first", initialState: "empty", schemaSource: "selected-pack-baseline", existingDataPolicy: "out-of-scope", cfpg: { development: null, production: null } }, storage: { provider: "none", access: "private", uploadMode: "worker", maxUploadBytes: 10485760, development: { bucket: "starter-dev-objects" }, production: { bucket: "starter-objects" } }, email: { default: "cfsend", alternatives: ["resend", "cloudflare-email-service"] }, billing: "better-auth-stripe", release: "cloudflare-workers" },
    },
