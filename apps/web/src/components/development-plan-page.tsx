...
type MediaPolicy = { images: { provider: "none" | "cloudflare-images"; maxInputBytes: number; defaultFormat: string } };
type CatalogPack = {
  id: string;
...
type Snapshot = {
  ...
  assembly: {
    blueprint: {
      ...
      providers: { auth: string; socialAuth: string[]; database: DatabasePolicy; storage: StoragePolicy; antiAbuse: AntiAbusePolicy; ai: AiPolicy; search: SearchPolicy; push: PushPolicy; sms: SmsPolicy; media: MediaPolicy; email: { default: string; alternatives: string[] }; billing: string; release: string };
    };
