...
type Snapshot = {
  ...
  assembly: {
    blueprint: {
      ...
      providers: { auth: string; socialAuth: string[]; database: DatabasePolicy; storage: StoragePolicy; antiAbuse: AntiAbusePolicy; ai: AiPolicy; search: SearchPolicy; push: PushPolicy; email: { default: string; alternatives: string[] }; billing: string; release: string };
    };
