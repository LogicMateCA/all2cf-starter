...
type DatabasePolicy = { engine: "postgresql"; provider: "native-postgresql" | "cfpg"; transports?: { development: "native-postgresql" | "cfpg"; production: "native-postgresql" | "cfpg" }; access: "sql-first"; initialState: "empty"; schemaSource: "selected-pack-baseline"; existingDataPolicy: "out-of-scope"; cfpg: { development: { databaseId: string } | null; production: { databaseId: string } | null } };
