...
export function ProtectedApp() {
  ...
  return <div className="product-shell">
    <header className="product-header"><ProductBrand /><nav><a href="/app" aria-current={!settings ? "page" : undefined}>Workspace</a><a href="/app/settings" aria-current={settings ? "page" : undefined}>Settings</a></nav><AccountControl compact /></header>
