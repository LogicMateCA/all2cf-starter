...
This optional pack uses Better Auth's built-in Two-Factor plugin on the same `1.7.1` line as core. It provides verified TOTP enrollment, sign-in challenges, trusted-device choice, one-time backup-code recovery, backup-code rotation, account lockout, and password-confirmed disablement.
