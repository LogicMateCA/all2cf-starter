/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/wrangler.development.jsonc workers/app/worker-configuration.development.d.ts` (hash: 03e6fb9fabfa8ac416ed1db46edb738f)
...
interface __BaseEnv_Env {
	...
	AUTH_EMAIL_MODE: "database-outbox";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "SERVICE_NAME" | "APP_NAME" | "AUTH_CANONICAL_ORIGIN" | "AUTH_REQUIRE_EMAIL_VERIFICATION" | "AUTH_EMAIL_MODE" | "MOBILE_DEEP_LINK_SCHEMES" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET">> {}
}
