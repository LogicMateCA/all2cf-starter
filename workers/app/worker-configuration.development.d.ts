/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/wrangler.development.jsonc workers/app/worker-configuration.development.d.ts` (hash: 74f3df0348ebb24e17a8c03ed6a80169)
