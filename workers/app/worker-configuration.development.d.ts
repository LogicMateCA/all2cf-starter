/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/wrangler.development.jsonc workers/app/worker-configuration.development.d.ts` (hash: b832ea266d5f3284fbb23b58df6e6d64)
