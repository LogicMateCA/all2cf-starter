/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/wrangler.production.jsonc workers/app/worker-configuration.production.d.ts` (hash: 58250fabdc4e1562bbd6601fc3a7de43)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "SERVICE_NAME" | "APP_NAME" | "AUTH_CANONICAL_ORIGIN" | "AUTH_REQUIRE_EMAIL_VERIFICATION" | "AUTH_EMAIL_PROVIDER" | "RESEND_API_URL" | "MOBILE_DEEP_LINK_SCHEMES" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "CFSEND_API_URL" | "CFSEND_API_KEY" | "CFSEND_FROM">> {}
}
