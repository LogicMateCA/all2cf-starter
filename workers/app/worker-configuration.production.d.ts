/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/wrangler.production.jsonc workers/app/worker-configuration.production.d.ts` (hash: 7dfe3cf11d298bb73db5cd5b7e62b001)
