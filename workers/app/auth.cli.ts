...
if (!process.env.DATABASE_URL)
  throw new Error(
    "DATABASE_URL is required to generate the Better Auth schema",
  );
...
export const auth = createStarterAuth({
  ...
  secret:
    ...
    "schema-generation-secret-at-least-32-characters",
  ...
  stripeSecretKey:
    process.env.STRIPE_SECRET_KEY || "sk_test_schema_placeholder",
  stripeWebhookSecret:
    process.env.STRIPE_WEBHOOK_SECRET || "whsec_schema_placeholder",
