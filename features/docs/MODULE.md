...
- Setup and Provider documentation must link to the official application/configuration source recorded by the Provider Catalog; users should never need to search for the Google, CFsend, Resend, Stripe, Cloudflare Email Service, GitHub, Apple, R2, S3-compatible or Turnstile setup entry point.
